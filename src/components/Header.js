                ...
                <header>
                    <div className="header-container">
                        ...
                        <div className="social-media">
                            <a href="https://www.linkedin.com/in/jordan-wadsworth-harrell-37abaa68/" target="_blank" rel="noopener noreferrer" className="fa fa-linkedin"><span className="sr-only">Jordan's Linked In</span></a>
